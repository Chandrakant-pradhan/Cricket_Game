Navigate to cricket game folder and go to final game.html . First select the grid size from the available options 6 , 7 ,8 ,9 ,10 and then set it . Then click on flag to start the game. <br />
